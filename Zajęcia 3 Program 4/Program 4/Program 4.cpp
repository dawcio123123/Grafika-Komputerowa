...
float windowPos[5][3] = { { 0.2,-0.3, 0.51 },{ -0.2, -0.3, 0.51 },{ 0.2,-0.8, 0.51 },{ -0.2, -0.8, 0.51 },{ 0.2,-0.3, -0.51 } };
...
void DisplayScene()
{
	...
	for (int i = 0; i < 7; i++)
	{
		...
		glPushMatrix();
		glTranslatef(windowPos[i][0], windowPos[i][1], windowPos[i][2]);
